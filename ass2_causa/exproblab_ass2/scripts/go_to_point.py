...
def go_to_point(goal):
    ...
    feedback = exproblab_ass2.msg.go_to_pointFeedback()
    result = exproblab_ass2.msg.go_to_pointResult()
...
def main():
    ...
    act_s = actionlib.SimpleActionServer('/go_to_point', exproblab_ass2.msg.go_to_pointAction, go_to_point, auto_start=False) #action server
    act_s.start()
    rospy.spin()
